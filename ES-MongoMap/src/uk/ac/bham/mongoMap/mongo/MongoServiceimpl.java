...
//		// System.exit(0);
	...
	private class Consumer implements Runnable {
		...
		private Queue<Packet<Document>> queue;
		private DBCollection dbCollection;

		public Consumer(DBCollection dbCollection) {
			queue = new LinkedList<Packet<Document>>();
		...
		public void consume() {
			...
			while (!lastPacket) {
				...
				synchronized (queue) {
					Packet<Document> packet = queue.poll();
					queue.notify();
		...
		public Queue<Packet<Document>> getQueue() {
			return queue;
		}
