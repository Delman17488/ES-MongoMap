...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Datatye</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see uk.ac.bham.mongoMap.model.metamodel.sqlPackage#getDatatye()
 * @model
 * @generated
 */
public enum Datatye implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int TINYTEXT_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int LONGTEXT_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int SMALLINT_VALUE = 0;
	...
	/**
	 * An array of all the '<em><b>Datatye</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Datatye[] VALUES_ARRAY =
		new Datatye[] {
			INT,
			DOUBLE,
			BOOLEAN,
	...
	/**
	 * A public read-only list of all the '<em><b>Datatye</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Datatye> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	private Datatye(int value, String name, String literal) {
		this.value = value;
		this.name = name;
