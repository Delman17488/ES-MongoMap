...
public class MongoDBImpl extends MinimalEObjectImpl.Container implements MongoDB {
	...
	protected EClass eStaticClass() {
		return MongoPackage.Literals.MONGO_DB;
	}
	...
	public EList<Collection> getCollections() {
		if (collections == null) {
			collections = new EObjectContainmentEList<Collection>(Collection.class, this, MongoPackage.MONGO_DB__COLLECTIONS);
		}
		return collections;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MongoPackage.MONGO_DB__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MongoPackage.MONGO_DB__COLLECTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MongoPackage.MONGO_DB__NAME:
				return getName();
		}
