 ...
 * @generated
 */
public class ValueImpl extends MongoObjectImpl implements Value {
	/**
	...
	protected EClass eStaticClass() {
		return MongoPackage.Literals.VALUE;
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MongoPackage.VALUE__VALUE, oldValue, value));
	}
